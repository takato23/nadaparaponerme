...
export function CommandPalette({
    ...
    const commands: CommandItem[] = useMemo(() => [
        ...
        },
        {
            ...
            icon: 'auto_fix_high',
            shortcut: '3',
            action: () => { navigate(ROUTES.STUDIO); onClose(); },
            category: 'navigation',
        },
        {
            id: 'nav-looks',
            ...
            icon: 'style',
            shortcut: '4',
            action: () => { navigate(ROUTES.SAVED); onClose(); },
            category: 'navigation',
        },
        {
            id: 'nav-profile',
        ...
        },
        {
            id: 'action-looks',
            label: 'Abrir Looks',
            description: 'Revisar combinaciones guardadas',
            icon: 'style',
            shortcut: '⌘G',
            action: () => { navigate(ROUTES.SAVED); onClose(); },
            category: 'action',
        ...
        // Features
        {
            id: 'feature-planner',
            label: 'Plan semanal',
            description: 'Organizar looks para la semana',
            icon: 'calendar_month',
            action: () => { navigate(ROUTES.PLANNER); onClose(); },
            category: 'feature',
        },
        {
            id: 'feature-weather',
        ...
        },
        {
            id: 'feature-mirror',
            label: 'Espejo Pro',
            description: 'Validación visual premium',
            icon: 'view_in_ar',
            action: () => { navigate(ROUTES.STUDIO_MIRROR); onClose(); },
            category: 'feature',
        },

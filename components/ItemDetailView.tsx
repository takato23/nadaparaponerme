...
export const ItemDetailView = ({ item, inventory, onUpdate, onDelete, onBack, onGenerateOutfitWithItem, onSelectItem, onShareItem, onStartBrandRecognition, onStartDupeFinder }: ItemDetailViewProps) => {
  ...
  return (
    <div className="fixed inset-0 z-20 animate-fade-in">
        ...
        <div className="absolute inset-0 bg-white/80 dark:bg-background-dark/80 backdrop-blur-xl flex flex-col md:inset-y-0 md:right-0 md:left-auto md:w-full md:max-w-sm md:border-l md:border-white/20 animate-scale-in md:animate-slide-in-right">

# 🚀 Optimization Phase - Context Prompt

**Use este prompt para continuar con optimizaciones del proyecto con contexto limpio.**
...
```markdown
# Proyecto: No Tengo Nada Para Ponerme - Fase de Optimización
...
- **IA**: Google Gemini AI (26 funciones)
  - Gemini 2.5 Flash (análisis, chat)
  - Gemini 2.5 Pro (outfits, packing)
  - Imagen 4.0 (generación de imágenes)
- **Estado**: localStorage + Supabase (migración gradual)
- **Build**: Vite con code splitting y lazy loading

### Configuración Actual
- ✅ Build exitoso sin errores (4.44s)
- ✅ Gemini API configurado (frontend + backend)
- ✅ 3 Edge Functions deployadas
- ✅ Dev server corriendo: http://localhost:3002/
- ✅ Bundle size: ~1.2MB gzipped

### Documentación Clave
- `CLAUDE.md` - Guía del proyecto para Claude Code
- `CHANGELOG.md` - Todas las features documentadas
- `NEXT_STEPS.md` - Opciones de próximos pasos
- `GEMINI_README.md` - Configuración de Gemini API
- `README.md` - Documentación principal

## Objetivo: Optimizaciones & Polish 💎

Quiero optimizar el proyecto en las siguientes áreas:
...
- [ ] Remover código muerto (dead code elimination)
...
6. **Spanish UI**: Mantener todos los textos en español
...
**Core**:
- `src/App.tsx` - Estado centralizado, 2000+ líneas
- `services/geminiService.ts` - Todas las funciones de IA
- `src/services/aiService.ts` - Router de IA

**Heavy Components** (candidatos a optimización):
- `components/BulkUploadView.tsx` - Análisis batch de imágenes
- `components/CapsuleWardrobeBuilderView.tsx` - Generación compleja
- `components/StyleEvolutionView.tsx` - Análisis temporal
...
4. Optimizar imágenes (WebP conversion)
...
3. **Medir** el impacto de cada optimización
4. **Documentar** los cambios realizados

Empecemos con un análisis del bundle size y las dependencias pesadas.
```
...
2. **Abre** una nueva conversación en Claude Code
3. **Pega** el prompt completo
4. **Claude** tendrá todo el contexto necesario para continuar

---

## ✅ Qué Incluye Este Prompt

- ✅ Estado actual del proyecto (100% features)
- ✅ Stack tecnológico completo
- ✅ Configuración actual
- ✅ Objetivos de optimización detallados
- ✅ Comandos útiles
- ✅ Restricciones y consideraciones
...
**Listo para**: Nueva conversación con contexto completo
